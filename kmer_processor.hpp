#ifndef KMER_PROCESSOR_HPP
#define KMER_PROCESSOR_HPP
...
void read_line(string &line, multimap<string, string> &line_hm);
...
void from_line_to_segment(int k, unordered_map<string, string> &segment_hm, multimap<string, string> &line_hm);
